...
def test_visible_model_profiles_select_standard_and_ultra_limits():
    standard = limits_for_visible_model(RuntimeLimits(), "helmrail-standard")
    ultra = limits_for_visible_model(RuntimeLimits(), "helmrail-ultra")

    assert is_coordinator_model("helmrail-standard") is True
    assert is_coordinator_model("helmrail-ultra") is True
...
def test_explicit_global_limits_win_over_visible_model_profile_defaults():
    ...
    ultra = limits_for_visible_model(configured, "helmrail-ultra")
